    ...
    <section className="relative py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <motion.div
          ...
          className="bezel"
        >
          <div className="bezel-inner relative overflow-hidden p-10 md:p-16">
            ...
            <div
              className="absolute -right-20 top-1/2 -translate-y-1/2 h-72 w-72 rounded-full blur-3xl opacity-50"
            ...
            <div className="relative grid md:grid-cols-12 gap-10 items-center">
              <div className="md:col-span-7">
                ...
                <h2 className="text-balance text-3xl md:text-5xl leading-[1.05] tracking-tight font-semibold mb-5">
                  {t.cta.title}
                </h2>
                <p className="text-fg-soft text-pretty text-base md:text-lg leading-relaxed max-w-[55ch]">
                  {t.cta.body}
                </p>
              </div>
