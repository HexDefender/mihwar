  ...
  return (
    <section id="features" className="relative py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="flex flex-col items-start gap-4 mb-14 md:mb-20 max-w-3xl">
          ...
          <h2 className="text-balance text-3xl md:text-5xl leading-[1.08] tracking-tight font-semibold">
            {t.features.title}
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-4 md:auto-rows-[minmax(220px,auto)] gap-4">
              ...
              >
                <EquipmentTilt intensity={6} className="h-full">
                  <div className="bezel h-full">
                    <div className="bezel-inner h-full p-7 md:p-8 flex flex-col justify-between gap-6 relative overflow-hidden">
                      <div
                      ...
                      <div className="relative z-10">
                        <h3 className="text-xl md:text-[22px] font-semibold leading-tight tracking-tight mb-2">
                          {it.title}
                        </h3>
                        <p className="text-fg-soft text-[15px] leading-relaxed max-w-prose">{it.body}</p>
                      </div>
                    </div>
                  </div>
                </EquipmentTilt>
