...
export function FlowSection() {
  ...
  return (
    <section ref={ref} id="flow" className="relative py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="grid lg:grid-cols-12 gap-10 mb-16 md:mb-24">
          ...
          <div className="lg:col-span-7 lg:pt-10">
            <p className="text-pretty text-base md:text-lg leading-relaxed text-fg-soft max-w-prose">
        ...
        <div className="relative">
          ...
          <ol className="flex flex-col gap-12 md:gap-20">
            {t.flow.steps.map((step, i) => (
              ...
              >
                <div className={`flex items-start gap-5 ${i % 2 === 1 ? "md:flex-row-reverse md:text-end" : ""} pe-16 md:pe-0 md:px-10`}>
                  <div className="flex-1">
                    ...
                    <p className="text-fg-soft leading-relaxed text-[15px] max-w-md">{step.body}</p>
                  </div>
                </div>
